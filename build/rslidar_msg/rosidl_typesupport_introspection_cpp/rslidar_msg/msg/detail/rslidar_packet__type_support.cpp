...
{
  const auto & member =
    *reinterpret_cast<const std::array<uint8_t, 1248> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::array<uint8_t, 1248> *>(untyped_member);
  return &member[index];
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember RslidarPacket_message_member_array[2] = {
  {
    "stamp",  // name
    ...
    offsetof(rslidar_msg::msg::RslidarPacket, stamp),  // bytes offset in struct
