...
void SpawnModel_Request__rosidl_typesupport_introspection_c__SpawnModel_Request_init_function(
...
void SpawnModel_Request__rosidl_typesupport_introspection_c__SpawnModel_Request_fini_function(void * message_memory)
{
  gazebo_msgs__srv__SpawnModel_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SpawnModel_Request__rosidl_typesupport_introspection_c__SpawnModel_Request_message_member_array[5] = {
  {
    "model_name",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers SpawnModel_Request__rosidl_typesupport_introspection_c__SpawnModel_Request_message_members = {
  "gazebo_msgs__srv",  // message namespace
  "SpawnModel_Request",  // message name
  5,  // number of fields
  sizeof(gazebo_msgs__srv__SpawnModel_Request),
  SpawnModel_Request__rosidl_typesupport_introspection_c__SpawnModel_Request_message_member_array,  // message members
  SpawnModel_Request__rosidl_typesupport_introspection_c__SpawnModel_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  SpawnModel_Request__rosidl_typesupport_introspection_c__SpawnModel_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t SpawnModel_Request__rosidl_typesupport_introspection_c__SpawnModel_Request_message_type_support_handle = {
  0,
  &SpawnModel_Request__rosidl_typesupport_introspection_c__SpawnModel_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, srv, SpawnModel_Request)() {
  SpawnModel_Request__rosidl_typesupport_introspection_c__SpawnModel_Request_message_member_array[3].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Pose)();
  if (!SpawnModel_Request__rosidl_typesupport_introspection_c__SpawnModel_Request_message_type_support_handle.typesupport_identifier) {
    SpawnModel_Request__rosidl_typesupport_introspection_c__SpawnModel_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &SpawnModel_Request__rosidl_typesupport_introspection_c__SpawnModel_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void SpawnModel_Response__rosidl_typesupport_introspection_c__SpawnModel_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void SpawnModel_Response__rosidl_typesupport_introspection_c__SpawnModel_Response_fini_function(void * message_memory)
{
  gazebo_msgs__srv__SpawnModel_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SpawnModel_Response__rosidl_typesupport_introspection_c__SpawnModel_Response_message_member_array[2] = {
  {
    "success",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers SpawnModel_Response__rosidl_typesupport_introspection_c__SpawnModel_Response_message_members = {
  "gazebo_msgs__srv",  // message namespace
  "SpawnModel_Response",  // message name
  2,  // number of fields
  sizeof(gazebo_msgs__srv__SpawnModel_Response),
  SpawnModel_Response__rosidl_typesupport_introspection_c__SpawnModel_Response_message_member_array,  // message members
  SpawnModel_Response__rosidl_typesupport_introspection_c__SpawnModel_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  SpawnModel_Response__rosidl_typesupport_introspection_c__SpawnModel_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t SpawnModel_Response__rosidl_typesupport_introspection_c__SpawnModel_Response_message_type_support_handle = {
  0,
  &SpawnModel_Response__rosidl_typesupport_introspection_c__SpawnModel_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, srv, SpawnModel_Response)() {
  if (!SpawnModel_Response__rosidl_typesupport_introspection_c__SpawnModel_Response_message_type_support_handle.typesupport_identifier) {
    SpawnModel_Response__rosidl_typesupport_introspection_c__SpawnModel_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &SpawnModel_Response__rosidl_typesupport_introspection_c__SpawnModel_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
