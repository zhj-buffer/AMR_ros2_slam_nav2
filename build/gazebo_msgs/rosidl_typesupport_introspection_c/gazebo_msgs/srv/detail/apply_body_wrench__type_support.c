...
void ApplyBodyWrench_Request__rosidl_typesupport_introspection_c__ApplyBodyWrench_Request_init_function(
...
void ApplyBodyWrench_Request__rosidl_typesupport_introspection_c__ApplyBodyWrench_Request_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers ApplyBodyWrench_Request__rosidl_typesupport_introspection_c__ApplyBodyWrench_Request_message_members = {
  ...
  ApplyBodyWrench_Request__rosidl_typesupport_introspection_c__ApplyBodyWrench_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  ApplyBodyWrench_Request__rosidl_typesupport_introspection_c__ApplyBodyWrench_Request_fini_function  // function to terminate message instance (will not free memory)
};
...
void ApplyBodyWrench_Response__rosidl_typesupport_introspection_c__ApplyBodyWrench_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void ApplyBodyWrench_Response__rosidl_typesupport_introspection_c__ApplyBodyWrench_Response_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers ApplyBodyWrench_Response__rosidl_typesupport_introspection_c__ApplyBodyWrench_Response_message_members = {
  ...
  ApplyBodyWrench_Response__rosidl_typesupport_introspection_c__ApplyBodyWrench_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  ApplyBodyWrench_Response__rosidl_typesupport_introspection_c__ApplyBodyWrench_Response_fini_function  // function to terminate message instance (will not free memory)
};
