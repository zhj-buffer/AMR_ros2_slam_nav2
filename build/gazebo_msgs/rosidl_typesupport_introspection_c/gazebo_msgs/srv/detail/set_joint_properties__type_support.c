...
void SetJointProperties_Request__rosidl_typesupport_introspection_c__SetJointProperties_Request_init_function(
...
void SetJointProperties_Request__rosidl_typesupport_introspection_c__SetJointProperties_Request_fini_function(void * message_memory)
{
  gazebo_msgs__srv__SetJointProperties_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SetJointProperties_Request__rosidl_typesupport_introspection_c__SetJointProperties_Request_message_member_array[2] = {
  {
    "joint_name",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers SetJointProperties_Request__rosidl_typesupport_introspection_c__SetJointProperties_Request_message_members = {
  ...
  SetJointProperties_Request__rosidl_typesupport_introspection_c__SetJointProperties_Request_message_member_array,  // message members
  SetJointProperties_Request__rosidl_typesupport_introspection_c__SetJointProperties_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  SetJointProperties_Request__rosidl_typesupport_introspection_c__SetJointProperties_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t SetJointProperties_Request__rosidl_typesupport_introspection_c__SetJointProperties_Request_message_type_support_handle = {
  0,
  &SetJointProperties_Request__rosidl_typesupport_introspection_c__SetJointProperties_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, srv, SetJointProperties_Request)() {
  SetJointProperties_Request__rosidl_typesupport_introspection_c__SetJointProperties_Request_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, msg, ODEJointProperties)();
  if (!SetJointProperties_Request__rosidl_typesupport_introspection_c__SetJointProperties_Request_message_type_support_handle.typesupport_identifier) {
    SetJointProperties_Request__rosidl_typesupport_introspection_c__SetJointProperties_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &SetJointProperties_Request__rosidl_typesupport_introspection_c__SetJointProperties_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void SetJointProperties_Response__rosidl_typesupport_introspection_c__SetJointProperties_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void SetJointProperties_Response__rosidl_typesupport_introspection_c__SetJointProperties_Response_fini_function(void * message_memory)
{
  gazebo_msgs__srv__SetJointProperties_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SetJointProperties_Response__rosidl_typesupport_introspection_c__SetJointProperties_Response_message_member_array[2] = {
  {
    "success",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers SetJointProperties_Response__rosidl_typesupport_introspection_c__SetJointProperties_Response_message_members = {
  "gazebo_msgs__srv",  // message namespace
  "SetJointProperties_Response",  // message name
  2,  // number of fields
  sizeof(gazebo_msgs__srv__SetJointProperties_Response),
  SetJointProperties_Response__rosidl_typesupport_introspection_c__SetJointProperties_Response_message_member_array,  // message members
  SetJointProperties_Response__rosidl_typesupport_introspection_c__SetJointProperties_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  SetJointProperties_Response__rosidl_typesupport_introspection_c__SetJointProperties_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t SetJointProperties_Response__rosidl_typesupport_introspection_c__SetJointProperties_Response_message_type_support_handle = {
  0,
  &SetJointProperties_Response__rosidl_typesupport_introspection_c__SetJointProperties_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, srv, SetJointProperties_Response)() {
  if (!SetJointProperties_Response__rosidl_typesupport_introspection_c__SetJointProperties_Response_message_type_support_handle.typesupport_identifier) {
    SetJointProperties_Response__rosidl_typesupport_introspection_c__SetJointProperties_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &SetJointProperties_Response__rosidl_typesupport_introspection_c__SetJointProperties_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
