...
void DeleteLight_Request__rosidl_typesupport_introspection_c__DeleteLight_Request_init_function(
...
void DeleteLight_Request__rosidl_typesupport_introspection_c__DeleteLight_Request_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers DeleteLight_Request__rosidl_typesupport_introspection_c__DeleteLight_Request_message_members = {
  ...
  DeleteLight_Request__rosidl_typesupport_introspection_c__DeleteLight_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  DeleteLight_Request__rosidl_typesupport_introspection_c__DeleteLight_Request_fini_function  // function to terminate message instance (will not free memory)
};
...
void DeleteLight_Response__rosidl_typesupport_introspection_c__DeleteLight_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void DeleteLight_Response__rosidl_typesupport_introspection_c__DeleteLight_Response_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers DeleteLight_Response__rosidl_typesupport_introspection_c__DeleteLight_Response_message_members = {
  ...
  DeleteLight_Response__rosidl_typesupport_introspection_c__DeleteLight_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  DeleteLight_Response__rosidl_typesupport_introspection_c__DeleteLight_Response_fini_function  // function to terminate message instance (will not free memory)
};
