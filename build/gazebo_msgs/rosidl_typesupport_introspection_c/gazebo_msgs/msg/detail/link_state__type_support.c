...
void LinkState__rosidl_typesupport_introspection_c__LinkState_init_function(
...
void LinkState__rosidl_typesupport_introspection_c__LinkState_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers LinkState__rosidl_typesupport_introspection_c__LinkState_message_members = {
  ...
  LinkState__rosidl_typesupport_introspection_c__LinkState_init_function,  // function to initialize message memory (memory has to be allocated)
  LinkState__rosidl_typesupport_introspection_c__LinkState_fini_function  // function to terminate message instance (will not free memory)
};
