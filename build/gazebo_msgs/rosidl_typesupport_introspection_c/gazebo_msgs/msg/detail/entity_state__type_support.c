...
void EntityState__rosidl_typesupport_introspection_c__EntityState_init_function(
...
void EntityState__rosidl_typesupport_introspection_c__EntityState_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers EntityState__rosidl_typesupport_introspection_c__EntityState_message_members = {
  ...
  EntityState__rosidl_typesupport_introspection_c__EntityState_init_function,  // function to initialize message memory (memory has to be allocated)
  EntityState__rosidl_typesupport_introspection_c__EntityState_fini_function  // function to terminate message instance (will not free memory)
};
