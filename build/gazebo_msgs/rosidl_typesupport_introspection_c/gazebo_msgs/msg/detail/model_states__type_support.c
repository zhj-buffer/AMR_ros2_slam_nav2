...
void ModelStates__rosidl_typesupport_introspection_c__ModelStates_init_function(
...
void ModelStates__rosidl_typesupport_introspection_c__ModelStates_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers ModelStates__rosidl_typesupport_introspection_c__ModelStates_message_members = {
  ...
  ModelStates__rosidl_typesupport_introspection_c__ModelStates_init_function,  // function to initialize message memory (memory has to be allocated)
  ModelStates__rosidl_typesupport_introspection_c__ModelStates_fini_function  // function to terminate message instance (will not free memory)
};
