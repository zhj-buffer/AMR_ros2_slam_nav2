...
void ODEPhysics__rosidl_typesupport_introspection_c__ODEPhysics_init_function(
...
void ODEPhysics__rosidl_typesupport_introspection_c__ODEPhysics_fini_function(void * message_memory)
{
  gazebo_msgs__msg__ODEPhysics__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember ODEPhysics__rosidl_typesupport_introspection_c__ODEPhysics_message_member_array[10] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers ODEPhysics__rosidl_typesupport_introspection_c__ODEPhysics_message_members = {
  "gazebo_msgs__msg",  // message namespace
  "ODEPhysics",  // message name
  10,  // number of fields
  sizeof(gazebo_msgs__msg__ODEPhysics),
  ODEPhysics__rosidl_typesupport_introspection_c__ODEPhysics_message_member_array,  // message members
  ODEPhysics__rosidl_typesupport_introspection_c__ODEPhysics_init_function,  // function to initialize message memory (memory has to be allocated)
  ODEPhysics__rosidl_typesupport_introspection_c__ODEPhysics_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t ODEPhysics__rosidl_typesupport_introspection_c__ODEPhysics_message_type_support_handle = {
  0,
  &ODEPhysics__rosidl_typesupport_introspection_c__ODEPhysics_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gazebo_msgs, msg, ODEPhysics)() {
  if (!ODEPhysics__rosidl_typesupport_introspection_c__ODEPhysics_message_type_support_handle.typesupport_identifier) {
    ODEPhysics__rosidl_typesupport_introspection_c__ODEPhysics_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &ODEPhysics__rosidl_typesupport_introspection_c__ODEPhysics_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
