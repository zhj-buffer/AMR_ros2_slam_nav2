...
struct PerformanceMetrics_
{
  ...
  using _sensors_type =
    std::vector<gazebo_msgs::msg::SensorPerformanceMetric_<ContainerAllocator>, typename ContainerAllocator::template rebind<gazebo_msgs::msg::SensorPerformanceMetric_<ContainerAllocator>>::other>;
  ...
  Type & set__sensors(
    const std::vector<gazebo_msgs::msg::SensorPerformanceMetric_<ContainerAllocator>, typename ContainerAllocator::template rebind<gazebo_msgs::msg::SensorPerformanceMetric_<ContainerAllocator>>::other> & _arg)
  {
    this->sensors = _arg;
    return *this;
  }
