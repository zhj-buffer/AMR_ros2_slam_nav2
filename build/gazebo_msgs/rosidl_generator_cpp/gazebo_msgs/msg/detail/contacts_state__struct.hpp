...
struct ContactsState_
{
  ...
  _header_type header;
  using _states_type =
    std::vector<gazebo_msgs::msg::ContactState_<ContainerAllocator>, typename ContainerAllocator::template rebind<gazebo_msgs::msg::ContactState_<ContainerAllocator>>::other>;
  _states_type states;
  ...
  Type & set__states(
    const std::vector<gazebo_msgs::msg::ContactState_<ContainerAllocator>, typename ContainerAllocator::template rebind<gazebo_msgs::msg::ContactState_<ContainerAllocator>>::other> & _arg)
  {
    this->states = _arg;
    return *this;
  }
