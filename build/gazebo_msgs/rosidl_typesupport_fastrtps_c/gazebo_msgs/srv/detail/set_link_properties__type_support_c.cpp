...
static size_t _SetLinkProperties_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_gazebo_msgs__srv__SetLinkProperties_Request(
    full_bounded, 0);
}
...
static size_t _SetLinkProperties_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_gazebo_msgs__srv__SetLinkProperties_Response(
    full_bounded, 0);
}
