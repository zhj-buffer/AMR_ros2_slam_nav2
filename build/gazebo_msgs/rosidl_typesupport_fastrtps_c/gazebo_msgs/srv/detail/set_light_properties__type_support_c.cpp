...
static size_t _SetLightProperties_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_gazebo_msgs__srv__SetLightProperties_Request(
    full_bounded, 0);
}
...
static size_t _SetLightProperties_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_gazebo_msgs__srv__SetLightProperties_Response(
    full_bounded, 0);
}
