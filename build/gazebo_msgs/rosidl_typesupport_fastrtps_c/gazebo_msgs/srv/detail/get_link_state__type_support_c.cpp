...
static size_t _GetLinkState_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_gazebo_msgs__srv__GetLinkState_Request(
    full_bounded, 0);
}
...
static size_t _GetLinkState_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_gazebo_msgs__srv__GetLinkState_Response(
    full_bounded, 0);
}
