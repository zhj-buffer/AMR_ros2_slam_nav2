...
static size_t _ApplyLinkWrench_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_gazebo_msgs__srv__ApplyLinkWrench_Request(
    full_bounded, 0);
}
...
static size_t _ApplyLinkWrench_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_gazebo_msgs__srv__ApplyLinkWrench_Response(
    full_bounded, 0);
}
