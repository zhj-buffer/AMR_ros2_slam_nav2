...
{
  gazebo_msgs__srv__GetWorldProperties_Request * msg = (gazebo_msgs__srv__GetWorldProperties_Request *)malloc(sizeof(gazebo_msgs__srv__GetWorldProperties_Request));
  if (!msg) {
    return NULL;
  }
...
gazebo_msgs__srv__GetWorldProperties_Request__Sequence__init(gazebo_msgs__srv__GetWorldProperties_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (gazebo_msgs__srv__GetWorldProperties_Request *)calloc(size, sizeof(gazebo_msgs__srv__GetWorldProperties_Request));
    if (!data) {
      return false;
    }
...
{
  gazebo_msgs__srv__GetWorldProperties_Request__Sequence * array = (gazebo_msgs__srv__GetWorldProperties_Request__Sequence *)malloc(sizeof(gazebo_msgs__srv__GetWorldProperties_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  gazebo_msgs__srv__GetWorldProperties_Response * msg = (gazebo_msgs__srv__GetWorldProperties_Response *)malloc(sizeof(gazebo_msgs__srv__GetWorldProperties_Response));
  if (!msg) {
    return NULL;
  }
...
gazebo_msgs__srv__GetWorldProperties_Response__Sequence__init(gazebo_msgs__srv__GetWorldProperties_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (gazebo_msgs__srv__GetWorldProperties_Response *)calloc(size, sizeof(gazebo_msgs__srv__GetWorldProperties_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  gazebo_msgs__srv__GetWorldProperties_Response__Sequence * array = (gazebo_msgs__srv__GetWorldProperties_Response__Sequence *)malloc(sizeof(gazebo_msgs__srv__GetWorldProperties_Response__Sequence));
  if (!array) {
    return NULL;
  }
