...
static const _BmsFlagFb_type_support_symbol_names_t _BmsFlagFb_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_drive_package_msg, msg, BmsFlagFb)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_drive_package_msg, msg, BmsFlagFb)),
  }
};
...
{
  return &::ros2_drive_package_msg::msg::rosidl_typesupport_cpp::BmsFlagFb_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_drive_package_msg, msg, BmsFlagFb)() {
  return get_message_type_support_handle<ros2_drive_package_msg::msg::BmsFlagFb>();
}
