...
{
  ros2_drive_package_msg__msg__BmsFb * msg = (ros2_drive_package_msg__msg__BmsFb *)malloc(sizeof(ros2_drive_package_msg__msg__BmsFb));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2_drive_package_msg__msg__BmsFb));
  bool success = ros2_drive_package_msg__msg__BmsFb__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
{
  if (msg) {
    ros2_drive_package_msg__msg__BmsFb__fini(msg);
  }
  free(msg);
}
...
ros2_drive_package_msg__msg__BmsFb__Sequence__init(ros2_drive_package_msg__msg__BmsFb__Sequence * array, size_t size)
{
  ...
  ros2_drive_package_msg__msg__BmsFb * data = NULL;
  if (size) {
    data = (ros2_drive_package_msg__msg__BmsFb *)calloc(size, sizeof(ros2_drive_package_msg__msg__BmsFb));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2_drive_package_msg__msg__BmsFb__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ros2_drive_package_msg__msg__BmsFb__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
ros2_drive_package_msg__msg__BmsFb__Sequence__fini(ros2_drive_package_msg__msg__BmsFb__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2_drive_package_msg__msg__BmsFb__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  ros2_drive_package_msg__msg__BmsFb__Sequence * array = (ros2_drive_package_msg__msg__BmsFb__Sequence *)malloc(sizeof(ros2_drive_package_msg__msg__BmsFb__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = ros2_drive_package_msg__msg__BmsFb__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    ros2_drive_package_msg__msg__BmsFb__Sequence__fini(array);
  }
  free(array);
}
