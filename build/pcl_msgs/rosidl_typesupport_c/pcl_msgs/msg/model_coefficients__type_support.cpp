...
static const _ModelCoefficients_type_support_symbol_names_t _ModelCoefficients_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pcl_msgs, msg, ModelCoefficients)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pcl_msgs, msg, ModelCoefficients)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pcl_msgs, msg, ModelCoefficients)() {
  return &::pcl_msgs::msg::rosidl_typesupport_c::ModelCoefficients_message_type_support_handle;
}
