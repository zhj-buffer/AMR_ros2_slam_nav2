...
def generate_test_description():
    ...
    aggregator_node = ExecuteProcess(
        cmd=[
            ...
            "--ros-args",
            "--params-file",
            "/home/nvidia/workspace/alan/src/AMR_ros2_slam_nav2/ROS2-driver-for-Realsense/diagnostics/diagnostic_aggregator/test/all_analyzers.yaml"
            ],
...
class TestAggregator(unittest.TestCase):
    ...
    def test_processes_output(self, proc_output, aggregator_node):
        ...
        proc_output.assertWaitFor(
            expected_output=launch_testing.tools.expected_output_from_file(path="/home/nvidia/workspace/alan/src/AMR_ros2_slam_nav2/ROS2-driver-for-Realsense/diagnostics/diagnostic_aggregator/test/expected_output/all_analyzers"),
