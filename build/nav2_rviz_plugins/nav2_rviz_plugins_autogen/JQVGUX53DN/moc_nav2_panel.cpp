...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        InitialThread *_t = static_cast<InitialThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject nav2_rviz_plugins::InitialThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_nav2_rviz_plugins__InitialThread.data,
      qt_meta_data_nav2_rviz_plugins__InitialThread,  qt_static_metacall, nullptr, nullptr}
};
