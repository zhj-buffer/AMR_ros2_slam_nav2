...
static size_t _FollowWaypoints_Goal__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_nav2_msgs__action__FollowWaypoints_Goal(
    full_bounded, 0);
}
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: missed_waypoints
  {
    ...
    if (!rosidl_runtime_c__int32__Sequence__init(&ros_message->missed_waypoints, size)) {
      return "failed to create array for field 'missed_waypoints'";
    }
    auto array_ptr = ros_message->missed_waypoints.data;
...
static size_t _FollowWaypoints_Result__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_nav2_msgs__action__FollowWaypoints_Result(
    full_bounded, 0);
}
...
static size_t _FollowWaypoints_Feedback__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_nav2_msgs__action__FollowWaypoints_Feedback(
    full_bounded, 0);
}
...
static size_t _FollowWaypoints_SendGoal_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_nav2_msgs__action__FollowWaypoints_SendGoal_Request(
    full_bounded, 0);
}
...
static size_t _FollowWaypoints_SendGoal_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_nav2_msgs__action__FollowWaypoints_SendGoal_Response(
    full_bounded, 0);
}
...
static size_t _FollowWaypoints_GetResult_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_nav2_msgs__action__FollowWaypoints_GetResult_Request(
    full_bounded, 0);
}
...
static size_t _FollowWaypoints_GetResult_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_nav2_msgs__action__FollowWaypoints_GetResult_Response(
    full_bounded, 0);
}
...
static size_t _FollowWaypoints_FeedbackMessage__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_nav2_msgs__action__FollowWaypoints_FeedbackMessage(
    full_bounded, 0);
}
