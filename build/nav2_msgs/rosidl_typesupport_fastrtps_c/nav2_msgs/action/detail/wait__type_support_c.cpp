...
{
  return max_serialized_size_nav2_msgs__action__Wait_Goal(
    full_bounded, 0);
}
...
{
  return max_serialized_size_nav2_msgs__action__Wait_Result(
    full_bounded, 0);
}
...
{
  return max_serialized_size_nav2_msgs__action__Wait_Feedback(
    full_bounded, 0);
}
...
{
  return max_serialized_size_nav2_msgs__action__Wait_SendGoal_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_nav2_msgs__action__Wait_SendGoal_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_nav2_msgs__action__Wait_GetResult_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_nav2_msgs__action__Wait_GetResult_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_nav2_msgs__action__Wait_FeedbackMessage(
    full_bounded, 0);
}
