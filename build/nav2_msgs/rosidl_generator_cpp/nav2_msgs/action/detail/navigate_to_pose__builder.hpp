...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::nav2_msgs::action::NavigateToPose_Result result(::nav2_msgs::action::NavigateToPose_Result::_result_type arg)
  {
...
{
  return nav2_msgs::action::builder::Init_NavigateToPose_Result_result();
}
...
public:
  ...
  : msg_(msg)
  {}
  Init_NavigateToPose_Feedback_number_of_recoveries navigation_time(::nav2_msgs::action::NavigateToPose_Feedback::_navigation_time_type arg)
  {
