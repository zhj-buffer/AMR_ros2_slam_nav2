...
static rosidl_typesupport_introspection_c__MessageMember DeviceInfo_Response__rosidl_typesupport_introspection_c__DeviceInfo_Response_message_member_array[6] = {
  {
    "device_name",  // name
