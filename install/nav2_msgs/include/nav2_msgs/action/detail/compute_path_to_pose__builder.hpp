...
public:
  ...
  : msg_(msg)
  {}
  ::nav2_msgs::action::ComputePathToPose_Goal planner_id(::nav2_msgs::action::ComputePathToPose_Goal::_planner_id_type arg)
  {
...
public:
  ...
  {}
  Init_ComputePathToPose_Goal_planner_id pose(::nav2_msgs::action::ComputePathToPose_Goal::_pose_type arg)
  {
...
{
  return nav2_msgs::action::builder::Init_ComputePathToPose_Goal_pose();
}
