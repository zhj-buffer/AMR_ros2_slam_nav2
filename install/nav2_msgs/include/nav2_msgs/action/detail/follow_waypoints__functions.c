...
{
  nav2_msgs__action__FollowWaypoints_Goal * msg = (nav2_msgs__action__FollowWaypoints_Goal *)malloc(sizeof(nav2_msgs__action__FollowWaypoints_Goal));
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__FollowWaypoints_Goal__Sequence__init(nav2_msgs__action__FollowWaypoints_Goal__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__FollowWaypoints_Goal *)calloc(size, sizeof(nav2_msgs__action__FollowWaypoints_Goal));
    if (!data) {
      return false;
    }
...
{
  nav2_msgs__action__FollowWaypoints_Goal__Sequence * array = (nav2_msgs__action__FollowWaypoints_Goal__Sequence *)malloc(sizeof(nav2_msgs__action__FollowWaypoints_Goal__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  nav2_msgs__action__FollowWaypoints_Result * msg = (nav2_msgs__action__FollowWaypoints_Result *)malloc(sizeof(nav2_msgs__action__FollowWaypoints_Result));
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__FollowWaypoints_Result__Sequence__init(nav2_msgs__action__FollowWaypoints_Result__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__FollowWaypoints_Result *)calloc(size, sizeof(nav2_msgs__action__FollowWaypoints_Result));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  nav2_msgs__action__FollowWaypoints_Result__Sequence * array = (nav2_msgs__action__FollowWaypoints_Result__Sequence *)malloc(sizeof(nav2_msgs__action__FollowWaypoints_Result__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  nav2_msgs__action__FollowWaypoints_Feedback * msg = (nav2_msgs__action__FollowWaypoints_Feedback *)malloc(sizeof(nav2_msgs__action__FollowWaypoints_Feedback));
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__FollowWaypoints_Feedback__Sequence__init(nav2_msgs__action__FollowWaypoints_Feedback__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__FollowWaypoints_Feedback *)calloc(size, sizeof(nav2_msgs__action__FollowWaypoints_Feedback));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  nav2_msgs__action__FollowWaypoints_Feedback__Sequence * array = (nav2_msgs__action__FollowWaypoints_Feedback__Sequence *)malloc(sizeof(nav2_msgs__action__FollowWaypoints_Feedback__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  nav2_msgs__action__FollowWaypoints_SendGoal_Request * msg = (nav2_msgs__action__FollowWaypoints_SendGoal_Request *)malloc(sizeof(nav2_msgs__action__FollowWaypoints_SendGoal_Request));
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__FollowWaypoints_SendGoal_Request__Sequence__init(nav2_msgs__action__FollowWaypoints_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__FollowWaypoints_SendGoal_Request *)calloc(size, sizeof(nav2_msgs__action__FollowWaypoints_SendGoal_Request));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  nav2_msgs__action__FollowWaypoints_SendGoal_Request__Sequence * array = (nav2_msgs__action__FollowWaypoints_SendGoal_Request__Sequence *)malloc(sizeof(nav2_msgs__action__FollowWaypoints_SendGoal_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  nav2_msgs__action__FollowWaypoints_SendGoal_Response * msg = (nav2_msgs__action__FollowWaypoints_SendGoal_Response *)malloc(sizeof(nav2_msgs__action__FollowWaypoints_SendGoal_Response));
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__FollowWaypoints_SendGoal_Response__Sequence__init(nav2_msgs__action__FollowWaypoints_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__FollowWaypoints_SendGoal_Response *)calloc(size, sizeof(nav2_msgs__action__FollowWaypoints_SendGoal_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  nav2_msgs__action__FollowWaypoints_SendGoal_Response__Sequence * array = (nav2_msgs__action__FollowWaypoints_SendGoal_Response__Sequence *)malloc(sizeof(nav2_msgs__action__FollowWaypoints_SendGoal_Response__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  nav2_msgs__action__FollowWaypoints_GetResult_Request * msg = (nav2_msgs__action__FollowWaypoints_GetResult_Request *)malloc(sizeof(nav2_msgs__action__FollowWaypoints_GetResult_Request));
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__FollowWaypoints_GetResult_Request__Sequence__init(nav2_msgs__action__FollowWaypoints_GetResult_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__FollowWaypoints_GetResult_Request *)calloc(size, sizeof(nav2_msgs__action__FollowWaypoints_GetResult_Request));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  nav2_msgs__action__FollowWaypoints_GetResult_Request__Sequence * array = (nav2_msgs__action__FollowWaypoints_GetResult_Request__Sequence *)malloc(sizeof(nav2_msgs__action__FollowWaypoints_GetResult_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  nav2_msgs__action__FollowWaypoints_GetResult_Response * msg = (nav2_msgs__action__FollowWaypoints_GetResult_Response *)malloc(sizeof(nav2_msgs__action__FollowWaypoints_GetResult_Response));
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__FollowWaypoints_GetResult_Response__Sequence__init(nav2_msgs__action__FollowWaypoints_GetResult_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__FollowWaypoints_GetResult_Response *)calloc(size, sizeof(nav2_msgs__action__FollowWaypoints_GetResult_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  nav2_msgs__action__FollowWaypoints_GetResult_Response__Sequence * array = (nav2_msgs__action__FollowWaypoints_GetResult_Response__Sequence *)malloc(sizeof(nav2_msgs__action__FollowWaypoints_GetResult_Response__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  nav2_msgs__action__FollowWaypoints_FeedbackMessage * msg = (nav2_msgs__action__FollowWaypoints_FeedbackMessage *)malloc(sizeof(nav2_msgs__action__FollowWaypoints_FeedbackMessage));
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__FollowWaypoints_FeedbackMessage__Sequence__init(nav2_msgs__action__FollowWaypoints_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__FollowWaypoints_FeedbackMessage *)calloc(size, sizeof(nav2_msgs__action__FollowWaypoints_FeedbackMessage));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  nav2_msgs__action__FollowWaypoints_FeedbackMessage__Sequence * array = (nav2_msgs__action__FollowWaypoints_FeedbackMessage__Sequence *)malloc(sizeof(nav2_msgs__action__FollowWaypoints_FeedbackMessage__Sequence));
  if (!array) {
    return NULL;
  }
