...
struct BehaviorTreeLog_
{
  ...
  using _event_log_type =
    std::vector<nav2_msgs::msg::BehaviorTreeStatusChange_<ContainerAllocator>, typename ContainerAllocator::template rebind<nav2_msgs::msg::BehaviorTreeStatusChange_<ContainerAllocator>>::other>;
  ...
  Type & set__event_log(
    const std::vector<nav2_msgs::msg::BehaviorTreeStatusChange_<ContainerAllocator>, typename ContainerAllocator::template rebind<nav2_msgs::msg::BehaviorTreeStatusChange_<ContainerAllocator>>::other> & _arg)
  {
    this->event_log = _arg;
    return *this;
  }
