...
struct ParticleCloud_
{
  ...
  using _particles_type =
    std::vector<nav2_msgs::msg::Particle_<ContainerAllocator>, typename ContainerAllocator::template rebind<nav2_msgs::msg::Particle_<ContainerAllocator>>::other>;
  ...
  Type & set__particles(
    const std::vector<nav2_msgs::msg::Particle_<ContainerAllocator>, typename ContainerAllocator::template rebind<nav2_msgs::msg::Particle_<ContainerAllocator>>::other> & _arg)
  {
    this->particles = _arg;
    return *this;
  }
