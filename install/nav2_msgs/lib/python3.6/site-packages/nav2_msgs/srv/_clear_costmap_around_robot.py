...
class ClearCostmapAroundRobot_Request(metaclass=Metaclass_ClearCostmapAroundRobot_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.window_size_x = kwargs.get('window_size_x', float())
        self.window_size_y = kwargs.get('window_size_y', float())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.window_size_x != other.window_size_x:
            return False
        if self.window_size_y != other.window_size_y:
            return False
        return True
    ...
    def window_size_x(self):
        """Message field 'window_size_x'."""
        return self._window_size_x

    @window_size_x.setter
    def window_size_x(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'window_size_x' field must be of type 'float'"
        self._window_size_x = value

    @property
    def window_size_y(self):
        """Message field 'window_size_y'."""
        return self._window_size_y

    @window_size_y.setter
    def window_size_y(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'window_size_y' field must be of type 'float'"
        self._window_size_y = value
