...
void CriticScore__rosidl_typesupport_introspection_c__CriticScore_init_function(
...
void CriticScore__rosidl_typesupport_introspection_c__CriticScore_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers CriticScore__rosidl_typesupport_introspection_c__CriticScore_message_members = {
  ...
  CriticScore__rosidl_typesupport_introspection_c__CriticScore_init_function,  // function to initialize message memory (memory has to be allocated)
  CriticScore__rosidl_typesupport_introspection_c__CriticScore_fini_function  // function to terminate message instance (will not free memory)
};
